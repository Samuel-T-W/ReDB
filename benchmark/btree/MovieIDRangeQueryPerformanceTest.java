 ...
 */
public class MovieIDRangeQueryPerformanceTest {
	...
	private static final String RESULTS_CSV = "report/movieID_range_query_results.csv";
	...
	public void testRangeQueryPerformance() throws Exception {
		...
		for (int s = 0; s < selectivities.length; s++) {
			...
			endBytesArr[s] = toFixedBytes(endMovieID[s], MOVIE_ID_LEN);
		}
